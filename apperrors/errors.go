...
var (
	...
	ErrInvalidStatusInput        = errors.New("invalid update statue")
	ErrBrokenUrl                 = errors.New("this url isn't active")
	ErrExpiredUrl                = errors.New("url expired")
	ErrUnauthorized              = errors.New("not allowed to update this url")
	ErrInvalidExpirationInput    = errors.New("invalid expiration date")
	ErrWrongConfirmationPassword = errors.New("wrong confirmation password")
)
